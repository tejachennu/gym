...
const styles = {
  ...
  reportCard: { padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' },
  reportHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid var(--border, #2a2a30)', paddingBottom: '14px' },
  reportTitle: { margin: 0, fontSize: '1.25rem', color: '#FFFFFF', fontWeight: 700 },
  reportDate: { margin: '4px 0 0 0', color: 'var(--text-secondary, #AAAAAA)', fontSize: '0.85rem' },
  abnormalitiesBox: { backgroundColor: 'rgba(0, 0, 0, 0.3)', padding: '16px', borderRadius: '12px', border: '1px solid var(--border, #2a2a30)' },
  cardActions: {
    display: 'flex',
    gap: '12px',
